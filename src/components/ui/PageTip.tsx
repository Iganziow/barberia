...
export default function PageTip({ id, text }: { id: string; text: string }) {
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-[#c87941]/20 bg-[#c87941]/5 px-4 py-3">
      <span className="mt-0.5 text-[#c87941] text-lg leading-none shrink-0">💡</span>
